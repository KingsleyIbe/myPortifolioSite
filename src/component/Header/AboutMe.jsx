  ...
  <div className="p-10 bg-[#1c1a19] ml-[200px]">
    <section className="relative">
      ...
      <div className="flex gap-x-10 items-center text-[#fff] my-5">
        <button type="button" className="p-5 bg-[#ff6b00] b-radius"><a href="./images/kingsley-ibe-cv.pdf" download="Kingsley Ibe resume">Get My Resume</a></button>
        <Link to="/about" className="p-5 bg-[#ff6b00] b-radius">Read More</Link>
      </div>
    </section>
  </div>
);
