...
const Portfolio = () => {
  const data = Data;
  return (
    <div className="px-10 portfolio relative top-[100px]">
      <section>
                  ...
                  <ul key={uuidv4()} className="my-10 cards lg:flex gap-x-5 project-border p-5 bg-[#1c1a19]">
                    ...
                    <li>
                      ...
                      <li className="lg:flex gap-x-5 items-center tech">
                        <p className="project-border-1 p-2 myy">{item.tech[0] && item.tech[0]}</p>
                        <p className="project-border-1 p-2 myy">{item.tech[1] && item.tech[1]}</p>
                        <p className="project-border-1 p-2 myy">{item.tech[2] && item.tech[2]}</p>
                        <p className="project-border-1 p-2 myy">{item.tech[3] && item.tech[3]}</p>
                      </li>
